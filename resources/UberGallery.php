...
class UberGallery {
    ...
    public function __construct() {
        ...
        // Read and apply gallery config or throw error on failPowered by, UberGallery
     ...
     * Set theme name
     *
     * @param string $name Theme name (default = uber-responsive)
     * @return object Self
     * @access public
     */
    public function setThemeName($name = 'uber-responsive') {
